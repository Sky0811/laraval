                 ...
                 <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                    ...
                    商品类型：<select class="form-control input-sm m-b-10" name='Goods_type'> 
                                <option value="1" {{ ($ob->Goods_type == 1)?'selected':''}}>平板电脑</option>
                                <option value="2" {{ ($ob->Goods_type == 2)?'selected':''}}>手机</option>
                                <option value="3" {{ ($ob->Goods_type == 3)?'selected':''}}>平板充电器</option>
                                <option value="4" {{ ($ob->Goods_type == 4)?'selected':''}}>平板数据线</option>
                                <option value="5" {{ ($ob->Goods_type == 5)?'selected':''}}>手机数据线</option>
                                <option value="6" {{ ($ob->Goods_type == 6)?'selected':''}}>手机充电器</option>
                          </select>
                </div>
                 <div class="col-lg-12">
