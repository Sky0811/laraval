...
<div class="page-main channel buyphone-channel">
    <div class="container breadcrumbs"> 
        <a href="/home1">首页</a><span class="sep">/</span>选购{{ $data->GoodCate_name }}
    </div>
    <div class="container channel-nav">
    <ul class="clearfix">
        <li class="current">
            <a data-stat-id="37221d8e391cd561" onclick="_msq.push(['trackEvent', '8076ed7ffc35f6db-37221d8e391cd561', '', 'pcpid', '']);">选购{{ $data->GoodCate_name }}</a>
        </li>
        @foreach($goods as $v)
        @if($id==($v->Goods_type))
