                                    ...
                                    @if($v->GoodCate_id==$v1->Goods_type)
                                     <li style='display:block'>
                                         <div class="menu_content">
                                             ...
                                             <p class="menu_content_tit" style="margin:10px auto 10px auto;">{{$v1->Goods_name}}</p>
                                             </a>
                                             <a href="/detail/{{ $v1->Goods_id }}">
     ...
     <div id="big_banner_wrap">
         <ul id="banner_menu_wrap">
            ...
            @if($v1->GoodCate_fid==0)
             <li class="active">
                 <a href="/listq/{{ $v1->GoodCate_id }}">{{ $v1->GoodCate_name }}</a>
     ...
     <div id="main_show_box" name="main_show_box">
         <div id="floor_1">
              <div id="floor_head">
                  ...
                  <a class="more_span" href="/listq/{{ $v1->GoodCate_id}}">查看更多</a>
              </div>
         </div>
             ...
             <ul>
                @if($v1->GoodCate_id==1)
                 <li class="floor_goods_wrap_li_a">
                     <a href=""><img src="{{ asset('admin/upload/s_T1IhLjBC_T1RXrhCrK.jpg')}}"></a>
                 </li>
                 @endif
                 @foreach( $goods as $v)
                 @if($v->Goods_type==$v1->GoodCate_id)
