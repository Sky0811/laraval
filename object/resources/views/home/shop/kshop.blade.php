...
<html xml:lang="zh-CN" lang="zh-CN">
    <head>
        ...
        <script type="text/javascript" async="" src="{{ asset('/Home/kshop/js/mstr_004.js') }}"></script>
        <script type="text/javascript" async="" src="{{ asset('/Home/kshop/js/mstr_002.js') }}"></script>
        <script type="text/javascript" async="" src="{{ asset('/Home/kshop/js/mstr_003.js') }}"></script>
        <script type="text/javascript" async="" src="{{ asset('/Home/kshop/js/unjcV2.js') }}"></script>
        <script type="text/javascript" async="" src="{{ asset('/Home/kshop/js/mstr.js') }}"></script>
        <script type="text/javascript" async="" src="{{ asset('/Home/kshop/js/jquery.js') }}"></script>
        ...
        <div class="site-header site-mini-header">
            <div class="container">
                ...
                <div class="topbar-info" id="J_userInfo">
                    <span class="user">
                        <a rel="nofollow" class="user-name" href="http://my.mi.com/portal" target="_blank" data-stat-id="    249d537faf905cee" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-249d537faf905cee', '//my.mi.com/portal', 'pcpid', '']);">
                            <span class="name">
                                <script>
                        ...
                        <ul class="user-menu" style="display: none;">
                            <li>
                                 <a rel="nofollow" href="http://my.mi.com/portal" target="_blank" data-stat-id="e0b9e1d1fa8052a2" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-e0b9e1d1fa8052a2', '//my.mi.com/portal', 'pcpid', '']);">个人中心
                                 </a>
                            </li>
                                <li>
                                    <a rel="nofollow" href="http://order.mi.com/user/comment" target="_blank" data-stat-id="6d05445058873c2c" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-6d05445058873c2c', '//order.mi.com/user/comment', 'pcpid', '']);">评价晒单</a>
                                </li>
                                <li>
                                    <a rel="nofollow" href="http://order.mi.com/user/favorite" target="_blank" data-stat-id="32e2967e9a749d3d" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-32e2967e9a749d3d', '//order.mi.com/user/favorite', 'pcpid', '']);">我的喜欢
                                    </a>
                                </li>
                                <li>
                                    <a rel="nofollow" href="http://account.xiaomi.com/" target="_blank" data-stat-id="6c2aba14bc7f649a" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-6c2aba14bc7f649a', 'http://account.xiaomi.com/', 'pcpid', '']);">小米账户
                                     </a>
                                </li>
                                <li>
                                    <a rel="nofollow" href="http://order.mi.com/site/logout" data-stat-id="770a31519c713b11" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-770a31519c713b11', '//order.mi.com/site/logout', 'pcpid', '']);">退出登录
                                    </a>
                                </li>
                        </ul>
                    </span>
                    <span class="sep">|</span>
                    <a rel="nofollow" class="link link-order" href="http://static.mi.com/order/" target="_blank" data-stat-id="a9e9205e73f0742c" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-a9e9205e73f0742c', '//static.mi.com/order/', 'pcpid', '']);">我的订单</a>
                </div>
            </div>
        </div>
