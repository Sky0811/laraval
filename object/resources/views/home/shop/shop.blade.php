...
<html xml:lang="zh-CN" lang="zh-CN">
    <head>
        ...
        <script type="text/javascript" async="" src="{{asset('/Home/shop1/js/mstr_002.js')}}"></script>
        <script type="text/javascript" async="" src="{{asset('/Home/shop1/js/unjcV2.js')}}"></script>
        <script type="text/javascript" async="" src="{{asset('/Home/shop1/js/mstr.js')}}"></script>
        <script type="text/javascript" async="" src="{{asset('/Home/shop1/js/jquery-1.8.3.min.js')}}"></script>
...
<div class="page-main">
    <div class="container">
        ...
        <div class="cart-recommend container" id="J_miRecommendBox">
            <h2 class="xm-recommend-title"><span>探索黑科技，小米为发烧而生
        </div>
        ...
        <div class="container">
            ...
            <div class="footer-links clearfix">
                ...
                <div class="col-contact">
                    ...
                    <a rel="nofollow" class="btn btn-line-primary btn-small" href="http://www.mi.com/service/contact" target="_blank" data-stat-id="a7642f0a3475d686" onclick="_msq.push(['trackEvent', '08fae3d5cb3abaaf-a7642f0a3475d686', '//www.mi.com/service/contact', 'pcpid', '']);"><i class="iconfont"></i> 24小时在线客服</a>            
                </div>
            </div>
        </div>
    </div>
