...
<div id='nav'>
    ...
    <ul class="box-right">
        <li style="cursor: pointer;"><a href="/evaluate/{{ $data->Goods_id }}">用户评价</a></li>
    </ul>
</div>
<div id='nav2'>
<div>{{ $data->Goods_name }}</div>
    <ul class="box-right">
        <li><a href="/evaluate/{{ $data->Goods_id }}">用户评价</a></li>
    </ul>
</div>
<script>
...
<div class="xm-buyBox" id="J_buyBox">
    <div class="box clearfix">
        ...
        <div class="login-notic J_notic">
            <div class="container">
                为方便您购买，请提前登录 <a href="/home1/login" class="J_proLogin">立即登录</a> <a href="javascript:void(0);" class="iconfont J_proLoginClose"></a>
            </div>
        </div>
        @endif
        <div class="pro-choose-main container clearfix">
            ...
            <div class="pro-info span10">
                ...
                <!-- 提示 -->
                <p class="sale-desc" id="J_desc"><font color="#ff4a00">【4月10日-30日，4GB+64GB版本】</font>{{  $data->Goods_body }} </p>
                <!-- 选择第一级别 -->
                ...
                <div class="J_main">
                    ...
                    <div class="list-wrap" id="J_list">   <div class="pro-choose pro-choose-col2 J_step" > <div class="step-title">  选择版本   <span>MTK Helio X20 10核处理器 最高主频 2.1GHz，全网通 2.0</span>  </div> <ul class="step-list step-one clearfix" id="cc">   <li class="btn btn-biglarge active2"><a class='edition'><span class="name">{{ $data->Goods_edition}}</span><span class="price"> {{ $data->Goods_price }}元</span></a> </li>
                    <li class="btn btn-biglarge active1" style='display: none;float:right;'>收藏</li>
                    @if(!empty(session()->has('homeuser')))
                    <span style="display:none">{{ session('homeuser')->User_id }}</span>
                    <div style="display:none">{{ $data->Goods_id }}</div>
                    @endif
                   <!--  <li class="btn btn-biglarge active1" style='display: none;float:right;'><a href="/home1/login" style="text-align:center;color:#E0E0E0;">收藏</a></li> -->
                    </ul> </div>    <div class="pro-choose pro-choose-col2 J_step" data-index="1"></div> </div>
                    <div id="J_relation"></div>
                    <div class="pro-list" id="J_proList" > <ul>  
                    <li class="totlePrice">总计：{{ $data->Goods_price }}元</li> </ul></div>
                    <ul class="btn-wrap clearfix" id="J_buyBtnBox">       <li> <a href="/home2/cshop/{{ $data->Goods_id }}" class="btn btn-primary btn-biglarge J_proBuyBtn">加入购物车</a> </li>      </ul>
        ...
        <div class="pro-infomation" id="J_proInfo"> <div class="section ">  <img data-src="http://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/635496d1f56a31b0173f4b4c504e8b8a.jpg" class="slider">   </div> <div class="section ">  <img data-src="http://cdn.cnbj0.fds.api.mi-img.com/b2c-mimall-media/dc1b76ea7388c7cb4dc47840125f7ec1.jpg" class="slider">   </div></div>
