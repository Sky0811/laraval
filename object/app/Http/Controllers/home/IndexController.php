...
class IndexController extends Controller
{
    ...
    public function evaluat(Request $request)
    {
        $data = $request->except('_token');
        $list = $data['Eval_gid'];
        $state = $data['Eval_state'];
        $row = DB::table('evaluate')->where(['Eval_gid'=>$list,'Eval_state'=>$state])->select('Eval_time','Eval_text','Eval_name','Eval_reply')->get();
